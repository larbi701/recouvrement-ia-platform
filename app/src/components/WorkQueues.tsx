...
import { HITL_AMOUNT_THRESHOLD_MAD } from "@/lib/workflow";
...
export const WORK_QUEUES: {
  ...
  },
  {
    key: "high_value",
    label: "High Value",
    description: `Factures de plus de ${HITL_AMOUNT_THRESHOLD_MAD.toLocaleString("fr-FR")} MAD`,
    match: (i) => i.amountMad > HITL_AMOUNT_THRESHOLD_MAD,
  },
  {
    key: "promises",
    label: "Promises Due",
...
export function WorkQueueGrid({ items }: { items: WorklistItem[] }) {
  return (
